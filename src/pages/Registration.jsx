...
export default function Registration() {
    return (
        <section className="container flex justify-center items-center mt-10 mb-18">
            <form className="w-[440px] h-[550px]">
                <h2 className="font-poppins font-semibold text-[36px] text-theme text-center mb-15">Register</h2>
                ...
                <h2 className="font-poppins font-semibold text-[16px] text-theme mb-2">Password ( Again )</h2>
                <input type="password" className="w-full h-[43px] border border-[#E5E7EB] focus:outline-0 rounded-xl font-poppins font-normal text-[14px] placeholder:text-[#4b556398] pl-4 mb-6" />
                ...
                <p className="font-poppins font-normal text-[16px] text-secondary text-center mt-6 mb-18">Already a member?<Link to="/login" className="text-[#0EA5E9]"> Login</Link></p>
            </form>
        </section>
    )
}