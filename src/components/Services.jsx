      ...
      <div className="container h-[98px] border border-[#E5E7EB] rounded-2xl px-10 py-6 flex justify-between items-center">
        <div className="w-[303px] h-[50px] flex justify-start items-center gap-4 border-r-2 border-[#E5E7EB]">
          ...
          <div>
            ...
            <p className="font-poppins font-normal text-[14px] text-secondary">On orders over $50.00</p>
          </div>
        </div>
        <div className="w-[303px] h-[50px] flex justify-start items-center gap-4 border-r-2 border-[#E5E7EB]">
          <BsTruck className="text-[24px] text-theme"/>
          <div>
            ...
            <p className="font-poppins font-normal text-[14px] text-secondary">Just phone number</p>
          </div>
        </div>
        <div className="w-[303px] h-[50px] flex justify-start items-center gap-4 border-r-2 border-[#E5E7EB]">
          <BsTruck className="text-[24px] text-theme"/>
          <div>
            ...
            <p className="font-poppins font-normal text-[14px] text-secondary">Fast delivery worldwide</p>
          </div>
        </div>
        <div className="w-[303px] h-[50px] flex justify-start items-center gap-4">
          ...
          <div>
            ...
            <p className="font-poppins font-normal text-[14px] text-secondary">60 days return for any reason</p>
          </div>
        </div>
